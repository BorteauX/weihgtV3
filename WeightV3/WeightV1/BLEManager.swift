...
class BLEManage: NSObject,CBCentralManagerDelegate,CBPeripheralDelegate {
    ...
    func weightChange(h:UInt8 ,l:UInt8){
        ...
        if((h&0b11000000)==0b01000000){
            ...
            //weight = (Int(weightValue*22046/1000+5)/10)&0xfffe
    ...
    //寫入檔案
    func writeBody(body:Dictionary<String,UInt8>) {
    ...
    private func receiveData(Byte: Array<UInt8>){
        ...
        //相關數值
        case 0xd3:
            arrName = ["Fat","Water","Muscle","Bone","V-Fat","BMI"]
            ...
            arrValue = [bodyfat,water,muscle,bone,vfal,bmi]
            isFinish = true
